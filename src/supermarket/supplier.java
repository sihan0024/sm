...
public class supplier extends javax.swing.JPanel {
    ...
    try{
        ...
        String query = "INSERT INTO supplier (sup_name, contact) VALUES (?, ?)";
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try{
            ...
            ResultSet rs = ss.executeQuery("SELECT * FROM supplier WHERE id='"+search+"'");
            
            if(rs.next()){
                jTextField4.setText(rs.getString("sup_name"));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try{
            ...
            sss.executeUpdate("UPDATE supplier SET sup_name='"+name+"',contact='"+contact+"'WHERE id = '"+id+"'");
    ...
    private void sp_id_tbKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_sp_id_tbKeyReleased
        ...
        try{
            ...
            ResultSet rs = a.executeQuery("SELECT * FROM supplier WHERE sup_name LIKE  '%"+name+"%'");
