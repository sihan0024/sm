...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/multiuserlogin", "uid", "password");
        } catch (Exception e) {
            e.printStackTrace();
        }
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/supermarket/800_3912158_nrtpmr5ssql04grw8gpwmgm6y31bgqjl6irpqgaa_cute-supermarket-clipart-grocery-clip-art-groceries-shop-graphics.jpg"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       try {
    String query = "SELECT * FROM multiuserlogin WHERE uid=? AND password=? AND usertype=?";
    con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost/multiuserlogin", "root","" );
    pst = (PreparedStatement) con.prepareStatement(query);

    pst.setString(1, jTextField1.getText()); // UID
    pst.setString(2, String.valueOf(jPasswordField1.getPassword())); // Password
    pst.setString(3, String.valueOf(jComboBox1.getSelectedItem())); // UserType

    rs = pst.executeQuery();

    if (rs.next()) {
        JOptionPane.showMessageDialog(this, "UID and Password matched and you are logged in as " + rs.getString("usertype"));
